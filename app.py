...
# Отримуємо шлях до поточної папки, де лежить app.py
...
def equip_item():
    ...
    try:
        ...
        if data['type'] in ['weapon', 'armor']:
            ...
            # Виправлення для Render/PostgreSQL: очистка списку навичок
...
def buy_egg():
    try:
        ...
        new_pet = {
            ...
            "rarity": rarity, "color": RARITIES[rarity]["color"], "stage": 1, "exp": 0, 
...
def feed_pet():
    try:
        ...
        if pets[pet_idx]['exp'] >= lvl_req:
            ...
            # Оновлення імені пета залежно від стадії
